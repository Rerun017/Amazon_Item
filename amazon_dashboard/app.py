...
def load_data():
    import os
    # 数据文件路径：优先本地 ItemData 目录，其次项目内 data 目录（用于 Streamlit Cloud 部署）
    data_paths = [
        r"C:\Users\wan01\AppData\Roaming\TRAE SOLO CN\ItemData\Amazon_dataset.csv",
...
st.markdown(
    ...
    "📊 Amazon 电商数据分析看板 | 基于 Streamlit + Plotly 构建 | 分析者：姚日亨"
    "</p>",
    unsafe_allow_html=True
)
